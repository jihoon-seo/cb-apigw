...
import (
	...
	// TODO: Auth Module 처리 (HMAC or New)
	...
	// TODO: Opencensus 연동을 위한 Exporter 로드 및 초기화
...
// TODO: 핸들러 팩토리 처리 newHandlerFactory - Middleware들과 Opencensus 처리를 반영한 Gin Endpoint Handler 생성
// func newHandlerFactory(logger logging.Logger, metricsProducer *ginMetrics.Metrics) ginRouter.HandlerFactory {
// 	// TODO: Rate Limit 처리용 RouterHandlerFactory 구성
...
// TODO: New Engine 처리 newEngine - HTTP Server 운영과 연관되는 Middleware 구성을 처리한 Gin Engine 생성
...
// TODO: New Proxy Factory 처리 newProxyFactory - 지정된 BackendFactory를 기반으로 동작하는 ProxyFactory 생성
...
// TODO: New Backend Factory 처리 newBackendFactoryWithContext - 지정된 Context 기반에서 활용가능한 middleware들이 적용된 BackendFactory 생성
...
func SetupAndRun(ctx context.Context, sConf config.ServiceConfig) error {
	...
	// API Routing 정보를 관리하고 있는 Repository 구성
